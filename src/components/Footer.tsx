        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/80 hover:text-white transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about#team" className="text-gray-400 hover:text-gold transition-colors">
                  Our Team
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/privacy#cookies" className="text-gray-400 hover:text-gold transition-colors">
                  Cookie Policy
                </Link>
              </li>
            </ul>
