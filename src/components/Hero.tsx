          ...
          <div className="relative group cursor-pointer transform transition-all duration-300 hover:scale-105">
            ...
            <div className="relative">
              <img 
                ...
                className="w-auto h-[500px] relative object-scale-down"
              />
              <div className="absolute -bottom-8 left-0 right-0 bg-dark-light/80 backdrop-blur-sm p-4 rounded-lg border border-white/10 transition-all duration-300 group-hover:bg-dark-light/90 group-hover:border-gold/20">
                <div className="flex justify-between items-center">
                  ...
                  <div className="mx-2 text-gold transition-all duration-300 group-hover:scale-110">→</div>
                  <div className="text-center group-hover:transform group-hover:scale-105 transition-all duration-300">
