...
const ProductFeatures = () => {
  ...
  return (
    <section id="urban-problem" className="relative py-20 bg-dark-light overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-dark/90 via-dark-light to-dark/80"></div>
      ...
      <div className="absolute top-20 left-10 w-32 h-32 rounded-full bg-gradient-radial from-gold/5 to-transparent blur-xl"></div>
      <div className="absolute bottom-20 right-10 w-40 h-40 rounded-full bg-gradient-radial from-rosegold/5 to-transparent blur-xl"></div>
      ...
      <div ref={containerRef} className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block px-4 py-1 mb-6 rounded-full bg-black/30 backdrop-blur-sm border border-white/10 shadow-[0_4px_15px_rgba(0,0,0,0.1)]">
            <span className="text-gold text-sm font-medium">The Urban Skin Challenge</span>
          </div>
          ...
          {/* Pollution Visualization - Enhanced with gradients */}
          <div className="bg-black/40 backdrop-blur-md rounded-xl p-6 border border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.12)] mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end h-48">
              <div className="flex flex-col items-center">
                <div className="h-[30%] w-full bg-gradient-to-t from-green-400/70 to-green-400/10 rounded-t-md relative shadow-[0_4px_10px_rgba(0,255,0,0.1)]">
              ...
              <div className="flex flex-col items-center">
                <div className="h-[45%] w-full bg-gradient-to-t from-yellow-400/70 to-yellow-400/10 rounded-t-md relative shadow-[0_4px_10px_rgba(255,255,0,0.1)]">
              ...
              <div className="flex flex-col items-center">
                <div className="h-[65%] w-full bg-gradient-to-t from-orange-400/70 to-orange-400/10 rounded-t-md relative shadow-[0_4px_10px_rgba(255,165,0,0.1)]">
              ...
              <div className="flex flex-col items-center">
                <div className="h-[85%] w-full bg-gradient-to-t from-red-500/70 to-red-500/10 rounded-t-md relative shadow-[0_4px_10px_rgba(255,0,0,0.1)]">
              ...
              <div className="flex flex-col items-center">
                <div className="h-[95%] w-full bg-gradient-to-t from-red-600/80 to-red-600/10 rounded-t-md relative shadow-[0_4px_10px_rgba(255,0,0,0.15)] animate-pulse-gentle">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              ...
              className="group relative bg-black/40 backdrop-blur-md rounded-xl p-8 border border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-all duration-500 opacity-0 translate-y-10 hover-lift overflow-hidden"
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center w-16 h-16 mb-6 rounded-lg bg-black/30 border border-white/5 group-hover:bg-black/40 transition-colors duration-300 shadow-[0_4px_15px_rgba(0,0,0,0.1)]">
                  {feature.icon}
                </div>
